...
size_t fs_read(int fd, void *buf, size_t len)
{
	...
	if (len + files[fd].offset > file_table[files[fd].index].size)
	...
	ide_read(buf, files[fd].offset + file_table[files[fd].index].disk_offset, len);
