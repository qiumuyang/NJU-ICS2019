...
instr_func opcode_entry[256] = {
    ...
    /* 0x40 - 0x43*/ inc_rax, inc_rcx, inc_rdx, inc_rbx,
    /* 0x44 - 0x47*/ inc_rsp, inc_rbp, inc_rsi, inc_rdi,
    /* 0x48 - 0x4b*/ dec_rax, dec_rcx, dec_rdx, dec_rbx,
    /* 0x4c - 0x4f*/ dec_rsp, dec_rbp, dec_rsi, dec_rdi,
    /* 0x50 - 0x53*/ push_rax, push_rcx, push_rdx, push_rbx,
    /* 0x54 - 0x57*/ push_rsp, push_rbp, push_rsi, push_rdi,
    /* 0x58 - 0x5b*/ pop_rax, pop_rcx, pop_rdx, pop_rbx,
    /* 0x5c - 0x5f*/ pop_rsp, pop_rbp, pop_rsi, pop_rdi,
    /* 0x60 - 0x63*/ pusha_v, popa_v, inv, inv,
    /* 0x64 - 0x67*/ inv, inv, data_size_16, inv,
    /* 0x68 - 0x6b*/ push_imm_v, imul_irm2r_v, push_imm_b, imul_i8rm2r_v,
    ...
    /* 0x8c - 0x8f*/ inv, lea, mov_rm2s_w, pop_mem_v,
    ...
    /* 0xe8 - 0xeb*/ call_rel_v, jmp_rel_v, jmp_far_imm, jmp_rel_b,
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, call_rm_v, inv, jmp_rm_v, jmp_mem_v, push_mem_v, inv};
...
instr_func group_x87_df_entry[8] =
    ...
    /* the 7th func should be # x87_fcomip # which is not implemented in frame code*/
    /* use fucomip for substitution */
